...
public class RecreateDb {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(url, "root", "yjd999999");
            ...
            stmt.executeUpdate("DROP DATABASE IF EXISTS agritrace");
            System.out.println("Database 'agritrace' dropped.");

            stmt.executeUpdate("CREATE DATABASE agritrace DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci");
